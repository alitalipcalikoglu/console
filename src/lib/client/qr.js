/**
 * QR code encoder (byte mode, error correction level M, versions 1–10) producing an SVG string.
 * Enough for otpauth:// URIs. Implements ISO/IEC 18004: data codewords, Reed–Solomon blocks,
 * interleaving, module placement, mask selection by penalty, format information.
 */
export class QrCode {
  ...
  static #pickVersion(len) {
    ...
    throw new Error('text too long for QR versions 1-10');
  }
