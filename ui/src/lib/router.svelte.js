...
export const router = new Router([
  ...
  '/media/:sid', '/media/:sid/files/:id', '/gateway/:sid', '/audit/:sid', '/audit/:sid/events/:id', '/shortlink/:sid', '/shortlink/:sid/links/:id', '/flags/:sid', '/flags/:sid/flags/:id', '/scheduler/:sid', '/scheduler/:sid/jobs/:id', '/scheduler/:sid/runs/:id', '/audit', '/admins', '/account',
]);
